...
builder.Services.AddScoped(x => {
    ...
    return new HttpClient() { BaseAddress = new Uri("https://oapi.dingtalk.com/") };
});
...
builder.Services.AddScoped<IChartService, ChartService>();//builder.HostEnvironment.BaseAddress
